...
def build_jsonl_record(sample):
    ...
    metadata = {
        ...
        "osm_building_count_200m": _safe_int(sample.get("osm_building_count")),
        ...
        "osm_amenity_count_200m": _safe_int(sample.get("osm_amenity_count")),
        "osm_amenity_types": amenity_types,
        "osm_has_park_200m": bool(sample.get("osm_has_park")),
