...
PROFILES = {
    ...
    # 96 GB physical; we budget as 80 GB and leave ~16 GB headroom for activation
    # spikes on worst-case 5-image batches (same pattern as the A100/H100 profiles).
    "rtx_pro_6000_96gb":   dict(vram_gb=80,  image_max_edge=1024, lora_r=32, lora_alpha=32, lr=1e-4, initial_batch_guess=12, finetune_vision_layers=True),
